...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"ra.file.controller", "ra.file.service.imp", "ra.file.repository.imp", "ra.file.config"})
...
//        properties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQL8InnoDBDialect");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.file.model");
